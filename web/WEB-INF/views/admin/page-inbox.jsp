				...
				<div class="col-md-3">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body inbox-menu">
							...
							<ul>
								...
								<li>
									<a href="page-inbox.jsp#">Stared</a>
								</li>
								<li>
									<a href="page-inbox.jsp#"></i>Sent Mail</a>
								</li>
								<li>
									<a href="page-inbox.jsp#">Important<span class="label label-info">7</span></a>
								</li>
								<li>
									<a href="page-inbox.jsp#">Draft<span class="label label-warning">3</span></a>
								</li>
								<li>
									<a href="page-inbox.jsp#">Trash</a>
								</li>
								...
								<li>
									<a href="page-inbox.jsp#">Work <span class="label label-danger"></span></a>
								</li>
								<li>
									<a href="page-inbox.jsp#">Private <span class="label label-info"></span></a>
								</li>
								<li>
									<a href="page-inbox.jsp#">Clients <span class="label label-success"></span></a>
								</li>
								<li>
									<a href="page-inbox.jsp#">Travel <span class="label label-danger"></span></a>
								</li>
								<li>
									<a href="page-inbox.jsp#">Promotion <span class="label label-success"></span></a>
								</li>
								<li>
									<a href="page-inbox.jsp#">News <span class="label label-warning"></span></a>
								</li>
								<li>
									<a href="page-inbox.jsp#">Update <span class="label label-info"></span></a>
								</li>
							</ul>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body contacts">
							...
							<a href="page-inbox.jsp#" class="btn btn-primary btn-block"> + Contact</a>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<span class="btn-group">
								...
								<ul class="dropdown-menu">
									<li><a href="page-inbox.jsp#">add label <span class="label label-danger">Work</span></a></li>
									<li><a href="page-inbox.jsp#">add label <span class="label label-info">Private</span></a></li>
									<li><a href="page-inbox.jsp#">add label <span class="label label-success">Clients</span></a></li>
									<li><a href="page-inbox.jsp#">add label <span class="label label-danger">Travel</span></a></li>
									<li><a href="page-inbox.jsp#">add label <span class="label label-success">Promotion</span></a></li>
									<li><a href="page-inbox.jsp#">add label <span class="label label-warning">News</span></a></li>
									<li><a href="page-inbox.jsp#">add label <span class="label label-info">Update</span></a></li>
								</ul>
							</span>
							<button class="btn btn-default"><span class="fa fa-refresh"></span></button>

							<span class="btn-group pull-right">
								<button class="btn btn-default">1-25 of 500</button>
							...
							<ul class="messages-list">
								...
								<li class="unread">
									<a href="page-inbox-message.jsp">
										<div class="header">
											<span class="action"><i class="fa fa-square-o"></i></span> 
											<span class="from">Jhon Smith</span>
											<span class="date"><span class="fa fa-paper-clip"></span> Today, 08:45 AM</span>
										</div>
										<div class="title">
								...
								<li>
									<a href="page-inbox-message.jsp">
										<div class="header">
											<span class="action"><i class="fa fa-square-o"></i></span> 
											<span class="from">Jhon Smith</span>
											<span class="date">Today, 07:49 AM</span>
										</div>
										<div class="title">
											<span class="action"><i class="fa fa-star-o"></i></span>
											Contrary to popular belief, Lorem Ipsum is not simply random text. 
								...
								<li>
									<a href="page-inbox-message.jsp">
										<div class="header">
											<span class="action"><i class="fa fa-square-o"></i></span> 
											<span class="from">Jhon Smith</span>
											<span class="date">Yesterday, 11:57 AM</span>
										</div>
										<div class="title">
											<span class="action"><i class="fa fa-star-o"></i></span>
											Contrary to popular belief, Lorem Ipsum is not simply random text. 
