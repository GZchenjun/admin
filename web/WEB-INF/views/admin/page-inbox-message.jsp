	...
	<div class="navbar" role="navigation">
		...
		<div class="container-fluid">		
			...
			<ul class="nav navbar-nav navbar-actions navbar-left">
				<li class="visible-md visible-lg"><a href="page-inbox-message.jsp#" id="main-menu-toggle"><i class="fa fa-th-large"></i></a></li>
				<li class="visible-xs visible-sm"><a href="page-inbox-message.jsp#" id="sidebar-menu"><i class="fa fa-navicon"></i></a></li>
			</ul>
				...
				<div class="col-md-3">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body inbox-menu">
							...
							<ul>
								...
								<li>
									<a href="page-inbox-message.jsp#">Stared</a>
								</li>
								<li>
									<a href="page-inbox-message.jsp#">Sent Mail</a>
								</li>
								<li>
									<a href="page-inbox-message.jsp#">Important<span class="label label-info">7</span></a>
								</li>
								<li>
									<a href="page-inbox-message.jsp#">Draft<span class="label label-warning">3</span></a>
								</li>
								<li>
									<a href="page-inbox-message.jsp#">Trash</a>
								</li>
								...
								<li>
									<a href="page-inbox-message.jsp#">Work <span class="label label-danger"></span></a>
								</li>
								<li>
									<a href="page-inbox-message.jsp#">Private <span class="label label-info"></span></a>
								</li>
								<li>
									<a href="page-inbox-message.jsp#">Clients <span class="label label-success"></span></a>
								</li>
								<li>
									<a href="page-inbox-message.jsp#">Travel <span class="label label-danger"></span></a>
								</li>
								<li>
									<a href="page-inbox-message.jsp#">Promotion <span class="label label-success"></span></a>
								</li>
								<li>
									<a href="page-inbox-message.jsp#">News <span class="label label-warning"></span></a>
								</li>
								<li>
									<a href="page-inbox-message.jsp#">Update <span class="label label-info"></span></a>
								</li>
							</ul>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body contacts">
							...
							<a href="page-inbox-message.jsp#" class="btn btn-primary btn-block"> + Contact</a>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body message">
							...
							<span class="btn-group">
								...
								<ul class="dropdown-menu">
									<li><a href="page-inbox-message.jsp#">add label <span class="label label-danger">Work</span></a></li>
									<li><a href="page-inbox-message.jsp#">add label <span class="label label-info">Private</span></a></li>
									<li><a href="page-inbox-message.jsp#">add label <span class="label label-success">Clients</span></a></li>
									<li><a href="page-inbox-message.jsp#">add label <span class="label label-danger">Travel</span></a></li>
									<li><a href="page-inbox-message.jsp#">add label <span class="label label-success">Promotion</span></a></li>
									<li><a href="page-inbox-message.jsp#">add label <span class="label label-warning">News</span></a></li>
									<li><a href="page-inbox-message.jsp#">add label <span class="label label-info">Update</span></a></li>
								</ul>
							</span>
								...
								<ul>
									<li>
										...
										<span class="quickMenu">
											<a href="page-inbox-message.jsp#" class="fa fa-search"><i></i></a>
											<a href="page-inbox-message.jsp#" class="fa fa-share"><i></i></a>
											<a href="page-inbox-message.jsp#" class="fa fa-cloud-download"><i></i></a>
										</span>
									</li>
									<li>
