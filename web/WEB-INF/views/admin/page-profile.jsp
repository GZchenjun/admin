	...
	<div class="navbar" role="navigation">
		...
		<div class="container-fluid">		
			...
			<ul class="nav navbar-nav navbar-actions navbar-left">
				<li class="visible-md visible-lg"><a href="page-profile.jsp#" id="main-menu-toggle"><i class="fa fa-th-large"></i></a></li>
				<li class="visible-xs visible-sm"><a href="page-profile.jsp#" id="sidebar-menu"><i class="fa fa-navicon"></i></a></li>
			</ul>
					...
					<div class="panel panel-default">
						<div class="panel-body">
							<div class="text-center">
								<img class="img-profile" src="assets/img/avatar.jpg">
							</div>
							
							<h3 class="text-center"><strong>Jhon Smith</strong></h3>
							<h4 class="text-center"><small><i class="fa fa-map-marker"></i> California, USA</small></h4>
                        ...
                        <div class="panel-body">
                            <form class="form-vertical hover-stripped" role="form">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="JhonSmith" disabled>
                                    <a href="#" class="help-block">Request new ?</a> 
                                </div>
                                <div class="form-group">
                                    <label class="control-label">Full name</label>
                                    <input type="text" class="form-control" value="Jhon Smith">
                                </div>
                                <div class="form-group">
