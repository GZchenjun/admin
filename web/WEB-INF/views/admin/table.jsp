	...
	<div class="navbar" role="navigation">
		...
		<div class="container-fluid">		
			...
			<ul class="nav navbar-nav navbar-actions navbar-left">
				<li class="visible-md visible-lg"><a href="table.jsp#" id="main-menu-toggle"><i class="fa fa-th-large"></i></a></li>
				<li class="visible-xs visible-sm"><a href="table.jsp#" id="sidebar-menu"><i class="fa fa-navicon"></i></a></li>
			</ul>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<table class="table">
							 ...
							 <ul class="pagination">
								<li><a href="table.jsp#">Prev</a></li>
								<li class="active">
								  <a href="table.jsp#">1</a>
								</li>
								<li><a href="table.jsp#">2</a></li>
								<li><a href="table.jsp#">3</a></li>
								<li><a href="table.jsp#">4</a></li>
								<li><a href="table.jsp#">5</a></li>
								<li><a href="table.jsp#">Next</a></li>
							  </ul>     
						</div>
					</div>
				</div><!--/col-->
