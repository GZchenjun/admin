...
<body>
	...
	<div class="navbar" role="navigation">
		...
		<div class="container-fluid">		
			...
			<ul class="nav navbar-nav navbar-actions navbar-left">
				<li class="visible-md visible-lg"><a href="ui-panels.jsp#" id="main-menu-toggle"><i class="fa fa-th-large"></i></a></li>
				<li class="visible-xs visible-sm"><a href="ui-panels.jsp#" id="sidebar-menu"><i class="fa fa-navicon"></i></a></li>
			</ul>
	...
	<div class="container-fluid content">
		...
		<div class="main ">
			...
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-list-alt"></i>Panels</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="index.jsp">Home</a></li>
						<li><i class="fa fa-briefcase"></i><a href="#">UI Features</a></li>				
						<li><i class="fa fa-list-alt"></i>Panels</li>
					</ol>
				</div>
			</div>
