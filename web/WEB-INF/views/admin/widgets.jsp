		...
		<div class="main ">
			...
			<div class="row">
				...
				<div class="col-lg-3 col-sm-6 col-xs-6 col-xxs-12">
					<div class="smallstat red-bg">
						...
						<span class="value black">$1 859,00</span>
			...
			<div class="row">				
				...
				<div class="col-md-4">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h2><i class="fa fa-life-bouy red"></i><strong>Recent Users</strong></h2>							
						</div>
						<div class="panel-body no-padding">
							<ul class="users-list">
								<li>
									...
									<div class="name">Jhon Smith 
										<div class="dropdown pull-right">
											<a class="fa fa-comments" data-toggle="dropdown" href="widgets.jsp#"></a>
											<ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
												<li><a href="widgets.jsp#"><i class="fa fa-facebook"></i> Facebook</a></li>
												<li><a href="widgets.jsp#"><i class="fa fa-twitter"></i> Twitter</a></li>
												<li><a href="widgets.jsp#"><i class="fa fa-skype"></i> Skype</a></li>
												<li><a href="widgets.jsp#"><i class="fa fa-instagram"></i> Instagram</a></li>
											</ul>
										</div>
									</div>
									<span class="place"><i class="fa fa-map-marker"></i>California, USA</span><br>
									<span class="job">Admin</span>
									<span class="pull-right"><a href=""><small><i class="fa fa-trash-o"></i>Delete</small></a></span>
								</li>
								<li>
									<a href="widgets.jsp#">
										<img class="avatar" alt="Bill" src="assets/img/avatar7.jpg">
									</a>
									<div class="name">Sharon Rose
										<div class="dropdown pull-right">
											<a class="fa fa-comments" data-toggle="dropdown" href="widgets.jsp#"></a>
											<ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
												<li><a href="widgets.jsp#"><i class="fa fa-facebook"></i> Facebook</a></li>
									...
									<span class="place"><i class="fa fa-map-marker"></i>Texas, USA</span><br>
									<span class="job">Staff</span>
									<span class="pull-right"><a href=""><small><i class="fa fa-trash-o"></i>Delete</small></a></span>                                 
								</li>
								<li>
									<a href="widgets.jsp#">
										<img class="avatar" alt="Jane" src="assets/img/avatar3.jpg">
									</a>
									<div class="name">Nadine
										<div class="dropdown pull-right">
											<a class="fa fa-comments" data-toggle="dropdown" href="widgets.jsp#"></a>
											<ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
												<li><a href="widgets.jsp#"><i class="fa fa-facebook"></i> Facebook</a></li>
									...
									<span class="place"><i class="fa fa-map-marker"></i>Kentucky, USA</span><br>
									<span class="job">Staff</span>
									<span class="pull-right"><a href=""><small><i class="fa fa-trash-o"></i>Delete</small></a></span>                               
								</li>
								<li>
									<a href="widgets.jsp#">
										<img class="avatar" alt="Kate" src="assets/img/avatar2.jpg">
									</a>
									<div class="name">James
										<div class="dropdown pull-right">
											<a class="fa fa-comments" data-toggle="dropdown" href="widgets.jsp#"></a>
											<ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
												<li><a href="widgets.jsp#"><i class="fa fa-facebook"></i> Facebook</a></li>
									...
									<span class="place"><i class="fa fa-map-marker"></i>Los Angles, USA</span><br>
									<span class="job"></i>Staff</span>
									<span class="pull-right"><a href=""><small><i class="fa fa-trash-o"></i>Delete</small></a></span>                               
								</li>						
							</ul>
						</div>
				...
				<div class="col-md-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h2><i class="fa fa-life-bouy red"></i><strong>Comments</strong></h2>
							<div class="panel-actions">
								<a href="charts-xcharts.html#" class="btn-setting"><i class="fa fa-rotate-right"></i></a>
								<a href="widgets.jsp#" class="btn-minimize"><i class="fa fa-chevron-up"></i></a>
								<a href="widgets.jsp#" class="btn-close"><i class="fa fa-times"></i></a>
						...
						<div class="panel-body no-padding">
							<ul class="comments-list">
								<li>
									...
									<div>
										<strong>Jhon Smith</strong> - Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.
									</div>
									<div class="date">3 hours ago</div>
									<div class="like-comment"><a href="#">Like</a><small><strong> 2.596</strong> People liked this</small></div>
								</li>
								<li>
									<a href="widgets.jsp#">
										<img class="avatar" alt="Bill" src="assets/img/avatar1.jpg">
									</a>
									<div>
										<strong>Victor</strong> - Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.
									</div>
								...
								<li>
									...
									<div>
										<strong>Kevin</strong> - Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.
									</div>
								...
								<li>
									<a href="widgets.jsp#">
										<img class="avatar" alt="Kate" src="assets/img/avatar7.jpg">
									</a>
									<div>
										<strong>Sharon Rose</strong> - Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.
									</div>
