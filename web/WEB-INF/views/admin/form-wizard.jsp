	...
	<div class="navbar" role="navigation">
		...
		<div class="container-fluid">		
			...
			<ul class="nav navbar-nav navbar-actions navbar-left">
				<li class="visible-md visible-lg"><a href="form-wizard.jsp#" id="main-menu-toggle"><i class="fa fa-th-large"></i></a></li>
				<li class="visible-xs visible-sm"><a href="form-wizard.jsp#" id="sidebar-menu"><i class="fa fa-navicon"></i></a></li>
			</ul>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<div id="wizard1" class="wizard-type1">
								<ul class="steps">
								  	<li><a href="form-wizard.jsp#tab11" data-toggle="tab"><span class="badge badge-info"><i class="fa fa-star"></i></span> User Name</a></li>
									<li><a href="form-wizard.jsp#tab12" data-toggle="tab"><span class="badge badge-info"><i class="fa fa-credit-card"></i></span> Card Information</a></li>
									<li><a href="form-wizard.jsp#tab13" data-toggle="tab"><span class="badge badge-info"><i class="fa fa-building"></i></span> Company Details</a></li>
									<li><a href="form-wizard.jsp#tab14" data-toggle="tab"><span class="badge badge-info"><i class="fa fa-check"></i></span> Agreement</a></li>
								</ul>
								<div class="progress thin">
									...
									<div class="tab-pane" id="tab14">
										...
										<div class="form-group">
											<div class="checkbox">
					                            ...
					                            <input type="checkbox" id="checkbox1-w1" name="checkbox1-w1" value="option1"> I agree with <a href="form-wizard.jsp#">Terms of Service</a>
					                            </label>
					                        </div>
										</div>
								    </div>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<div id="wizard2" class="wizard-type2">							
								<ul class="steps">
								  	<li><a href="form-wizard.jsp#tab21" data-toggle="tab"><span class="badge badge-info"><i class="fa fa-star"></i></span> User Name</a></li>
									<li><a href="form-wizard.jsp#tab22" data-toggle="tab"><span class="badge badge-info"><i class="fa fa-credit-card"></i></span> Card Information</a></li>
									<li><a href="form-wizard.jsp#tab23" data-toggle="tab"><span class="badge badge-info"><i class="fa fa-building"></i></span> Company Details</a></li>
									<li><a href="form-wizard.jsp#tab24" data-toggle="tab"><span class="badge badge-info"><i class="fa fa-check"></i></span> Agreement</a></li>
								</ul>
								<div class="progress thin">
									<div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="width: 0%;">
									</div>
									...
									<div class="tab-pane" id="tab24">
										...
										<div class="form-group">
											<div class="checkbox">
					                            ...
					                            <input type="checkbox" id="checkbox1-w2" name="checkbox1-w2" value="option1"> I agree with <a href="form-wizard.jsp#">Terms of Service</a>
					                            </label>
					                        </div>
										</div>
								    </div>
