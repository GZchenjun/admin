...
<body>
	...
	<div class="navbar" role="navigation">
		...
		<div class="container-fluid">		
			...
			<ul class="nav navbar-nav navbar-actions navbar-left">
				<li class="visible-md visible-lg"><a href="ui-nestable-list.jsp#" id="main-menu-toggle"><i class="fa fa-th-large"></i></a></li>
				<li class="visible-xs visible-sm"><a href="ui-nestable-list.jsp#" id="sidebar-menu"><i class="fa fa-navicon"></i></a></li>
			</ul>
	...
	<div class="container-fluid content">
		...
		<div class="main ">
			...
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-outdent"></i>Nestable Lists</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="index.jsp">Home</a></li>
						<li><i class="fa fa-briefcase"></i><a href="#">UI Features</a></li>				
						<li><i class="fa fa-outdent"></i>Nestable Lists</li>
					</ol>
				</div>
			</div>
				...
				<div class="col-sm-6">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h2><i class="fa fa-outdent red"></i><strong>Nestable List</strong></h2>
							<div class="panel-actions">
								<a href="ui-nestable-list.jsp#" class="btn-setting"><i class="fa fa-rotate-right black"></i></a>
								<a href="ui-nestable-list.jsp#" class="btn-minimize"><i class="fa fa-chevron-up black"></i></a>
								<a href="ui-nestable-list.jsp#" class="btn-close"><i class="fa fa-times black"></i></a>
							</div>
						</div>
							...
							<div class="dd" id="nestable">
					            <ol class="dd-list">
					                <li class="dd-item" data-id="1">
					                    <div class="dd-handle">Item 1<a href="ui-nestable-list.jsp#" class="icon icon-trash"></a></div>
					                </li>
					                <li class="dd-item" data-id="2">
					                    <div class="dd-handle">Item 2<a href="ui-nestable-list.jsp#" class="icon icon-trash"></a><a href="ui-nestable-list.jsp#" class="icon icon-pencil"></a></div>
					                    <ol class="dd-list">
						...
						<div class="panel-footer">
							<menu id="nestable-menu">
								<button type="button" class="btn btn-danger" data-action="expand-all">Expand All</button>
