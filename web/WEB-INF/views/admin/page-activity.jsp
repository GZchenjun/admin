	...
	<div class="navbar" role="navigation">
		...
		<div class="container-fluid">		
			...
			<ul class="nav navbar-nav navbar-actions navbar-left">
				<li class="visible-md visible-lg"><a href="page-activity.jsp#" id="main-menu-toggle"><i class="fa fa-th-large"></i></a></li>
				<li class="visible-xs visible-sm"><a href="page-activity.jsp#" id="sidebar-menu"><i class="fa fa-navicon"></i></a></li>
			</ul>
				...
				<div class="col-md-6">
					...
					<div class="panel panel-default">
					  	<div class="panel-heading">
							...
							<div><a href="page-activity.jsp#"><strong>Jhon Smith</strong></a></div>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
					  	...
					  	<div class="panel-footer">												
							...
							<div class="media">
							  	<a class="pull-left" href="page-activity.jsp#">
							    	<img class="media-object img-rounded" src="assets/img/avatar7.jpg">
							  	</a>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
					  	...
					  	<div class="panel-footer">												
							...
							<div class="media">
							  	<a class="pull-left" href="page-activity.jsp#">
							    	<img class="media-object img-rounded" src="assets/img/avatar6.jpg">
							  	</a>
							  	<div class="media-body">
									<div class="pull-right small">30 minutes ago</div>
									<a href="page-activity.jsp#">
				...
				<div class="col-md-6">
					  	...
					  	<div class="panel-body">
							...
							<div class="row">
								...
								<div class="col-lg-4 col-md-6 col-xs-12">
									<img class="img-responsive" src="assets/img/gallery/photo1.jpg">
								</div><!--/.col-->
					...
					<div class="panel default">
						...
						<div class="panel-footer">												
							...
							<div class="media">
							  	<a class="pull-left" href="page-activity.jsp#">
							    	<img class="media-object img-rounded" src="assets/img/avatar3.jpg">
							  	</a>
							  	<div class="media-body">
									<div class="pull-right small">30 minutes ago</div>
									<a href="page-activity.jsp#">
