...
<body>
	...
	<div class="navbar" role="navigation">
		...
		<div class="container-fluid">		
			...
			<ul class="nav navbar-nav navbar-actions navbar-left">
				<li class="visible-md visible-lg"><a href="page-inbox-compose.jsp#" id="main-menu-toggle"><i class="fa fa-th-large"></i></a></li>
				<li class="visible-xs visible-sm"><a href="page-inbox-compose.jsp#" id="sidebar-menu"><i class="fa fa-navicon"></i></a></li>
			</ul>
	...
	<div class="container-fluid content">
		...
		<div class="main ">
			...
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-pencil-square-o"></i>Compose</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="index.jsp">Home</a></li>
						<li><i class="fa fa-file-text"></i><a href="#">Pages</a></li>
						<li><i class="fa fa-envelope"></i><a href="#">Mail</a></li>
						<li><i class="fa fa-pencil-square-o"></i>Compose</li>
					</ol>
				</div>
			</div>
				...
				<div class="col-md-3">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body inbox-menu">
							...
							<a href="page-inbox-compose.jsp" class="btn btn-danger btn-block">Compose</a>

							<ul>
								<li>
									<a href="page-inbox.jsp">Inbox<span class="label label-danger">10</span></a>
								</li>
								<li>
									<a href="page-inbox-compose.jsp#">Stared</a>
								</li>
								<li>
									<a href="page-inbox-compose.jsp#">Sent Mail</a>
								</li>
								<li>
									<a href="page-inbox-compose.jsp#">Important<span class="label label-info">7</span></a>
								</li>
								<li>
									<a href="page-inbox-compose.jsp#">Draft<span class="label label-warning">3</span></a>
								</li>
								<li>
									<a href="page-inbox-compose.jsp#"></i>Trash</a>
								</li>
								...
								<li>
									<a href="page-inbox-compose.jsp#">Work <span class="label label-danger"></span></a>
								</li>
								<li>
									<a href="page-inbox-compose.jsp#">Private <span class="label label-info"></span></a>
								</li>
								<li>
									<a href="page-inbox-compose.jsp#">Clients <span class="label label-success"></span></a>
								</li>
								<li>
									<a href="page-inbox-compose.jsp#">Travel <span class="label label-danger"></span></a>
								</li>
								<li>
									<a href="page-inbox-compose.jsp#">Promotion <span class="label label-success"></span></a>
								</li>
								<li>
									<a href="page-inbox-compose.jsp#">News <span class="label label-warning"></span></a>
								</li>
								<li>
									<a href="page-inbox-compose.jsp#">Update <span class="label label-info"></span></a>
								</li>
							</ul>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body contacts">
							...
							<a href="page-inbox-compose.jsp#" class="btn btn-primary btn-block"> + Contact</a>
						...
						<div class="panel-body message">							
							...
							<form class="form-horizontal" role="form">
								<div class="form-group">
							    	...
							    	<div class="col-sm-11">
							      		<input type="email" class="form-control" id="to" placeholder="Mail address">
							    	</div>
							  	</div>
								<div class="form-group">
							    	<label for="cc" class="col-sm-1 control-label">CC:</label>
							    	<div class="col-sm-11">
							      		<input type="email" class="form-control" id="cc" placeholder="Mail address">
							    	</div>
							  	</div>
								<div class="form-group">
							    	<label for="bcc" class="col-sm-1 control-label">BCC:</label>
							    	<div class="col-sm-11">
							      		<input type="email" class="form-control" id="bcc" placeholder="Mail address">
							    	</div>
							  	</div>
							...
							<div class="col-sm-11 col-sm-offset-1">
								...
								<div class="btn-toolbar" role="toolbar">
									...
									<div class="btn-group">
										...
										<ul class="dropdown-menu">
											<li><a href="page-inbox-compose.jsp#">add label <span class="label label-danger">Work</span></a></li>
											<li><a href="page-inbox-compose.jsp#">add label <span class="label label-info">Private</span></a></li>
											<li><a href="page-inbox-compose.jsp#">add label <span class="label label-success">Clients</span></a></li>
											<li><a href="page-inbox-compose.jsp#">add label <span class="label label-danger">Travel</span></a></li>
											<li><a href="page-inbox-compose.jsp#">add label <span class="label label-success">Promotion</span></a></li>
											<li><a href="page-inbox-compose.jsp#">add label <span class="label label-warning">News</span></a></li>
											<li><a href="page-inbox-compose.jsp#">add label <span class="label label-info">Update</span></a></li>
										</ul>
									</div>
	...
	<script src="assets/js/pages/page-inbox-compose.js"></script>
