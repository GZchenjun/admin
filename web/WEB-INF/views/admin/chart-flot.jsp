...
<script type="text/javascript">
	...
	<%----%>
		<%--<div class="container-fluid">		--%>
			...
			<%--<ul class="nav navbar-nav navbar-actions navbar-left">--%>
				<%--<li class="visible-md visible-lg"><a href="chart-flot.jsp#" id="main-menu-toggle"><i class="fa fa-th-large"></i></a></li>--%>
				<%--<li class="visible-xs visible-sm"><a href="chart-flot.jsp#" id="sidebar-menu"><i class="fa fa-navicon"></i></a></li>--%>
			<%--</ul>--%>
			<%----%>
	...
	<script src="<%=path%>/assets/js/pages/charts-flot.js"></script>
