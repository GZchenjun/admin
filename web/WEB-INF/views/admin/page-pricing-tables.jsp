	...
	<div class="navbar" role="navigation">
		...
		<div class="container-fluid">		
			...
			<ul class="nav navbar-nav navbar-actions navbar-left">
				<li class="visible-md visible-lg"><a href="page-pricing-tables.jsp#" id="main-menu-toggle"><i class="fa fa-th-large"></i></a></li>
				<li class="visible-xs visible-sm"><a href="page-pricing-tables.jsp#" id="sidebar-menu"><i class="fa fa-navicon"></i></a></li>
			</ul>
					...
					<div class="price-table four">
						...
						<div class="plan">
							<ul>
								...
								<li class="select"><a class="btn btn-success" href="page-pricing-tables.jsp#">Buy Now</a></li>
							</ul>
						</div>	
