...
<body>
	...
	<div class="navbar" role="navigation">
		...
		<div class="container-fluid">		
			...
			<ul class="nav navbar-nav navbar-actions navbar-left">
				<li class="visible-md visible-lg"><a href="ui-sliders-progress.jsp#" id="main-menu-toggle"><i class="fa fa-th-large"></i></a></li>
				<li class="visible-xs visible-sm"><a href="ui-sliders-progress.jsp#" id="sidebar-menu"><i class="fa fa-navicon"></i></a></li>
			</ul>
	...
	<div class="container-fluid content">
		...
		<div class="main ">
			...
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-align-left"></i>Progress</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="index.jsp">Home</a></li>
						<li><i class="fa fa-briefcase"></i><a href="#">UI Features</a></li>				
						<li><i class="fa fa-align-left"></i>Progress</li>
					</ol>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h2><i class="fa fa-align-left red"></i><strong>Progress Bars</strong></h2>
						</div>
						<div class="panel-body">
							<table class="table">
								<tr>
									<td>Basic</td>
									<td>
										<div class="progressbar simpleProgress">75</div>
									</td>
								</tr>
								<tr>
									<td>Progress</td>
									<td>
										<div class="progressbar progress-success progressAnimate"></div>
										<div class="field_notice">Completed: <span class="must progressAnimateValue">100%</span></div>
									</td>
								</tr>
								<tr>
									<td>Upload</td>
									<td>
										<div class="progressbar progress-info progressUploadAnimate"></div>
										<div class="field_notice">Uploading: <span class="must progressUploadAnimateValue">0 Mb</span> / 50 Mb</div>
									</td>
								</tr>
								<tr>
									<td>Upload</td>
									<td>
										<div class="progressbar progress-danger progressUploadAnimate"></div>
										<div class="field_notice">Uploading: <span class="must progressUploadAnimateValue">0 Mb</span> / 53 Mb</div>
									</td>
								</tr>
								<tr>
									<td>Upload</td>
									<td>
										<div class="progressbar progress-warning progressUploadAnimate"></div>
										<div class="field_notice">Uploading: <span class="must progressUploadAnimateValue">0 Mb</span> / 100 Mb</div>
									</td>
								</tr>
								<tr>
									<td>Upload</td>
									<td>
										<div class="progressbar progressUploadAnimate"></div>
										<div class="field_notice">Uploading: <span class="must progressUploadAnimateValue">0 Mb</span> / 30 Mb</div>
									</td>
								</tr>
							</table>
						</div>	
				...
				<div class="col-md-6">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h2><i class="fa fa-align-left red"></i><strong>Progress Bars Slim</strong></h2>
						</div>
						<div class="panel-body">
							<table class="table">
								<tr>
									<td>Basic</td>
									<td>
										<div class="progressbar slim simpleProgress progressGreen">60</div>
									</td>
								</tr>
								<tr>
									<td>Progress</td>
									<td>
										<div class="progressbar slim progress-success progressAnimate progressLightOrange"></div>
										<div class="field_notice">Value: <span class="must progressAnimateValue">100%</span></div>
									</td>
								</tr>
								<tr>
									<td>Upload</td>
									<td>
										<div class="progressbar slim progress-info progressUploadAnimate"></div>
										<div class="field_notice">Uploading: <span class="must progressUploadAnimateValue">0 Mb</span> / 50 Mb</div>
									</td>
								</tr>
								<tr>
									<td>Upload</td>
									<td>
										<div class="progressbar slim progress-danger progressUploadAnimate"></div>
										<div class="field_notice">Uploading: <span class="must progressUploadAnimateValue">0 Mb</span> / 53 Mb</div>
									</td>
								</tr>
								<tr>
									<td>Upload</td>
									<td>
										<div class="progressbar slim progress-warning progressUploadAnimate"></div>
										<div class="field_notice">Uploading: <span class="must progressUploadAnimateValue">0 Mb</span> / 100 Mb</div>
									</td>
								</tr>
								<tr>
									<td>Upload</td>
									<td>
										<div class="progressbar slim progressUploadAnimate"></div>
										<div class="field_notice">Uploading: <span class="must progressUploadAnimateValue">0 Mb</span> / 30 Mb</div>
									</td>
								</tr>
							</table>
			...
			<div class="row">	
				<div class="col-md-6">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h2><i class="fa fa-align-left red"></i><strong>Standard Progress Bars</strong></h2>
							<div class="panel-actions">
								<a href="ui-sliders-progress.jsp#" class="btn-setting"><i class="fa fa-rotate-right black"></i></a>
								<a href="ui-sliders-progress.jsp#" class="btn-minimize"><i class="fa fa-chevron-up black"></i></a>
								<a href="ui-sliders-progress.jsp#" class="btn-close"><i class="fa fa-times black"></i></a>
							</div>
						</div>
						<div class="panel-body">
				...
				<div class="col-md-6">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h2><i class="fa fa-align-left red"></i><strong>Thin Progress Bars</strong></h2>
							<div class="panel-actions">
								<a href="ui-sliders-progress.jsp#" class="btn-setting"><i class="fa fa-rotate-right black"></i></a>
								<a href="ui-sliders-progress.jsp#" class="btn-minimize"><i class="fa fa-chevron-up black"></i></a>
								<a href="ui-sliders-progress.jsp#" class="btn-close"><i class="fa fa-times black"></i></a>
