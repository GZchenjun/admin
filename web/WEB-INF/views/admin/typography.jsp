...
<body>
	...
	<div class="navbar" role="navigation">
		...
		<div class="container-fluid">		
			...
			<ul class="nav navbar-nav navbar-actions navbar-left">
				<li class="visible-md visible-lg"><a href="typography.jsp#" id="main-menu-toggle"><i class="fa fa-th-large"></i></a></li>
				<li class="visible-xs visible-sm"><a href="typography.jsp#" id="sidebar-menu"><i class="fa fa-navicon"></i></a></li>
			</ul>
	...
	<div class="container-fluid content">
		...
		<div class="main ">
			...
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-font"></i>Typography</h3>
					<ol class="breadcrumb">
					...
					<div class="panel panel-default">                        
                        <div class="panel-heading">
							...
							<div class="panel-actions">
								<a href="ui-sliders-progress.jsp#" class="btn-setting"><i class="fa fa-rotate-right"></i></a>
								<a href="ui-sliders-progress.jsp#" class="btn-minimize"><i class="fa fa-chevron-up"></i></a>
								<a href="ui-sliders-progress.jsp#" class="btn-close"><i class="fa fa-times"></i></a>
							</div>
                        </div>
