...
<body>
	...
	<div class="navbar" role="navigation">
		...
		<div class="container-fluid">		
			...
			<ul class="nav navbar-nav navbar-actions navbar-left">
				<li class="visible-md visible-lg"><a href="ui-elements.jsp#" id="main-menu-toggle"><i class="fa fa-th-large"></i></a></li>
				<li class="visible-xs visible-sm"><a href="ui-elements.jsp#" id="sidebar-menu"><i class="fa fa-navicon"></i></a></li>
			</ul>
	...
	<div class="container-fluid content">
		...
		<div class="main ">
			...
			<div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-list"></i>Elements</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="index.jsp">Home</a></li>
						<li><i class="fa fa-briefcase"></i><a href="#">UI Features</a></li>				
						<li><i class="fa fa-list"></i>Elements</li>
					</ol>
				</div>
			</div>
				...
				<div class="col-lg-12 hideInIE8">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h2><i class="fa fa-list red"></i><span class="break"></span><strong>Toggle Buttons</strong></h2>
							<div class="panel-actions">
								<a href="index.jsp#" class="btn-setting"><i class="fa fa-rotate-right black"></i></a>
								<a href="index.jsp#" class="btn-minimize"><i class="fa fa-chevron-up black"></i></a>
								<a href="index.jsp#" class="btn-close"><i class="fa fa-times black"></i></a>
							</div>
						</div>
			...
			<div class="row">	
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="panel-heading">
							<h2><i class="fa fa-list red"></i><span class="break"></span><strong>Alerts</strong></h2>
							<div class="panel-actions">
								<a href="index.jsp#" class="btn-setting"><i class="fa fa-rotate-right black"></i></a>
								<a href="index.jsp#" class="btn-minimize"><i class="fa fa-chevron-up black"></i></a>
								<a href="index.jsp#" class="btn-close"><i class="fa fa-times black"></i></a>
			...
			<div class="row">	
				<div class="col-md-4">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h2><i class="fa fa-list red"></i><span class="break"></span><strong>Extended Elements</strong></h2>
							<div class="panel-actions">
								<a href="ui-elements.jsp#" class="btn-close"><i class="fa fa-times"></i></a>
							</div>
						</div>
						<div class="panel-body">
							<table class="table table-bordered table-striped">
								...
								<tr>
									<td>Popover</td>
									<td>
										<a href="ui-elements.jsp#" class="btn btn-warning" data-toggle="popover" title="A Title" data-content="And here's some amazing content. It's very engaging. right?">Click to toggle popover</a>
									</td>
								</tr>
								<tr>
									<td>Dialog</td>
									<td>
										<a href="ui-elements.jsp#" class="btn btn-success btn-setting">Click for dialog</a>
									</td>
								</tr>
								<tr>
									<td>Tooltip</td>
									<td>
										<a href="ui-elements.jsp#" title="Tooltip, you can change the position." data-rel="tooltip" class="btn btn-danger">Hover for tooltip</a>
									</td>
								</tr>
							</table>
						</div>	
				...
				<div class="col-md-2">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h2><i class="fa fa-list red"></i><span class="break"></span><strong>Labels</strong></h2>
						</div>
						<div class="panel-body">
							<table class="table table-bordered table-striped">
								<tbody>
				...
				<div class="col-md-6">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h2><i class="fa fa-list red"></i><span class="break"></span><strong>Tabs</strong></h2>
							<ul class="nav tab-menu nav-tabs" id="myTab">
								<li class="active"><a href="ui-elements.jsp#info">Info</a></li>
								<li><a href="ui-elements.jsp#custom">Custom</a></li>
								<li><a href="ui-elements.jsp#messages">Messages</a></li>
							</ul>
						</div>
						<div class="panel-body">
						...
						<div class="panel-body">
							...
							<div class="panel-group" id="accordion">
							  <div class="panel panel-default">
							    <div class="panel-heading">
							      <h4 class="panel-title">
							        <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="ui-elements.jsp#collapseOne">
							  ...
							  <div class="panel panel-default">
							    <div class="panel-heading">
							      <h4 class="panel-title">
							        <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="ui-elements.jsp#collapseTwo">
							  ...
							  <div class="panel panel-default">
							    <div class="panel-heading">
							      <h4 class="panel-title">
							        <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="ui-elements.jsp#collapseThree">
