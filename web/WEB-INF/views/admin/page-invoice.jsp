	...
	<div class="navbar" role="navigation">
		...
		<div class="container-fluid">		
			...
			<ul class="nav navbar-nav navbar-actions navbar-left">
				<li class="visible-md visible-lg"><a href="page-invoice.jsp#" id="main-menu-toggle"><i class="fa fa-th-large"></i></a></li>
				<li class="visible-xs visible-sm"><a href="page-invoice.jsp#" id="sidebar-menu"><i class="fa fa-navicon"></i></a></li>
			</ul>
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-credit-card"></i>Invoice</li>				
					</ol>
				</div>
			</div>
				...
				<div class="row header">
					...
					<div class="col-sm-4">
						<div class="panel panel-default">
							...
							<div class="panel-body">
								...
								<p>Blackstreet No. 256</p>
								<p>1256 California, USA</p>
								<p>Email: youragent@mail.com</p>
					...
					<div class="col-sm-4">
						<div class="panel panel-default">
							...
							<div class="panel-body">
								...
								<p>White Building No. 23</p>
								<p>3692 Nevada, USA</p>
								<p>Email: destinationclient@mail.com</p>
					...
					<div class="col-sm-4">
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<p>Invoice No.:<strong> 1258/JUL/14</strong></p>
								<p>Date: May 10, 2014</p>
								<p>VAT No.: 040.0253.001</p>
						...
						<table class="table table-striped table-responsive">
							...
							<tbody>
								...
								<tr>
									...
									<td class="left">VPS Package</td>
									<td class="left">Domain Name Registration</td>
                                ...
                                <tr>
									...
									<td class="left">Hosting Renewal</td>
								...
								<table class="table table-clear">
									<tbody>
										<tr>
											...
											<td class="right">$882,25</td>                                        
										</tr>
										<tr>
											<td class="left"><strong>Discount (25%)</strong></td>
											<td class="right">$220,56</td>                                        
										</tr>
										<tr>
											<td class="left"><strong>VAT (10%)</strong></td>
											<td class="right">$88,23</td>                                        
										</tr>
										<tr>
											<td class="left"><strong>Total</strong></td>
											<td class="right"><strong>$749,92</strong></td>                                        
										</tr>                                  
									</tbody>
								</table>
